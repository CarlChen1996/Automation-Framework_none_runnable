...
def execute(build_list, task_list):
    ...
    # tasklist member(taskitem): {name:task1, testscripts:[script1, script2,], uutlist:[{uut1:uutinformation}, {uut2:uutinformation}], needbuild:true}
    # uutinformation: {uut1:{hostname: uut1, ip:1.1.1.1, mac:1234566, version: win7}}
    # ********************************************************************************
    """
